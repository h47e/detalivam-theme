...
if ( dv_is_admin_module_request() ) {
    foreach ( array( 'inc/theme-options-admin.php', 'inc/seo-sitemap.php', 'inc/seo-admin.php', 'inc/store-admin.php', 'inc/theme-content-admin.php', 'inc/slugs.php', 'inc/uploads-tools-admin.php', 'inc/uploads-audit-cli.php' ) as $dv_theme_admin_module ) {
