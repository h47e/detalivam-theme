...
function dv_require_seo_sitemap_module() {
    if ( function_exists( 'dv_get_sitemap_xml' ) && function_exists( 'dv_get_sitemap_index_xml' ) ) {
        return true;
    }

    $path = defined( 'DV_DIR' ) ? DV_DIR . '/inc/seo-sitemap.php' : get_template_directory() . '/inc/seo-sitemap.php';
    if ( file_exists( $path ) ) {
        require_once $path;
    }

    return function_exists( 'dv_get_sitemap_xml' ) && function_exists( 'dv_get_sitemap_index_xml' );
}
...
function dv_maybe_output_sitemap_xml() {
    ...
    if ( ! dv_require_seo_sitemap_module() ) {
        return;
    }
