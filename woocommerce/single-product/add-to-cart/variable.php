				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						...
						<td class="value">
							...
							$reset_variations = '<a class="reset_variations" href="#" aria-label="' . esc_attr__( 'Clear options', 'woocommerce' ) . '">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>';
							echo end( $attribute_keys ) === $attribute_name ? wp_kses_post( apply_filters( 'woocommerce_reset_variations_link', $reset_variations ) ) : '';
							?>
						</td>
					</tr>
				<?php endforeach; ?>
